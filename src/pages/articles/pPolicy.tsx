...
export const PrivacyPolicyArticle = () => {
    return (
        <ArticleContent>
            ...
            <ArticleLI><span>За предоставяне на нашите услуги и поддръжка на потребителите</span></ArticleLI>
            <ArticleLI><span>За обработка на плащания и изпълнение на поръчки.</span></ArticleLI>
            <ArticleLI><span>За изпращане на информация, свързана с нашата услуга.</span></ArticleLI>
            <ArticleLI><span>За подобряване на нашия уебсайт и персонализиране на потребителския опит.</span></ArticleLI>
            <ArticleLI><span>За анализиране на трафика и поведението на потребителите на уебсайта.</span></ArticleLI>
            ...
            <ArticleLI>
                <span>Ако това е необходимо за изпълнение на нашите услуги и задачи като обработка на плащания.</span>
            </ArticleLI>
            <ArticleLI>
                <span>С вашето съгласие или по ваша инициатива, когато предоставите информацията за определена цел.</span>
            </ArticleLI>
            <ArticleLI>
                <span>Ако сме законно задължени да го направим спрямо приложимите закони и регулации.</span>
            </ArticleLI>
